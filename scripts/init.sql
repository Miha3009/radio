...
INSERT INTO users (name, email, password, role, avatar) VALUES 
  ...
  ('User 1', 'user1@yandex.ru', '$2a$10$H3RLgGWd6I872d1JTPiEXOyuL3x6SyfdvMoAEPQaGCupbZPuvJs6a', 1, 'avatar-1.jpg'),
  ('User 2', 'user2@yandex.ru', '$2a$10$DQnNxoRFOV2PEfKTMj5Y0uOSKwaLDu4PShMnIoVRTgnRlI.EJJ87y', 1, 'avatar-2.jpg'),
  ('User 3', 'user3@yandex.ru', '$2a$10$2hXFbpNkU4Zc7Q4hOUf/7Oa0IsKyaonQA.baVa24yt9DV3rUk.Um6', 1, 'avatar-3.jpg'),
  ('User 4', 'user4@yandex.ru', '$2a$10$V4iRIco2MBZzmlbSbrZzwuahAq3uTr9MG556jwzk2yDhDD0c4WicG', 1, 'avatar-4.jpg'),
...
INSERT INTO news (title, publication_date, image, content) VALUES
  ('Новость 1', NOW(), 'image1.jpg', '# Adspicit domum
...
oculos qua.'),
  ('Новость 2', NOW() - interval '1' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 3', NOW() - interval '2' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 4', NOW() - interval '3' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 5', NOW() - interval '4' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 6', NOW() - interval '5' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 7', NOW() - interval '6' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 8', NOW() - interval '7' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 9', NOW() - interval '8' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 10', NOW() - interval '9' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 11', NOW() - interval '10' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 12', NOW() - interval '11' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 13', NOW() - interval '12' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 14', NOW() - interval '13' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 15', NOW() - interval '14' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 16', NOW() - interval '15' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 17', NOW() - interval '16' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 18', NOW() - interval '17' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 19', NOW() - interval '18' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 20', NOW() - interval '19' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 21', NOW() - interval '20' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 22', NOW() - interval '21' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 23', NOW() - interval '22' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 24', NOW() - interval '23' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 25', NOW() - interval '24' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 26', NOW() - interval '25' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 27', NOW() - interval '26' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 28', NOW() - interval '27' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 29', NOW() - interval '28' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 30', NOW() - interval '29' hour, 'image3.jpg', '# Заголовок'),
  ('Новость 31', NOW() - interval '30' hour, 'image1.jpg', '# Заголовок'),
  ('Новость 32', NOW() - interval '31' hour, 'image2.jpg', '# Заголовок'),
  ('Новость 33', NOW() - interval '32' hour, 'image3.jpg', '# Заголовок');
